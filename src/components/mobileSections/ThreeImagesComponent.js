      ...
      <StyledTextButtonContainer>
        ...
        <StyledText>
          {addPaddingAfterFifthSentence(
            props.text ??
              "As a programmer, I find immense joy in coding outside of my professional responsibilities, delving into side projects to continually expand my skills and knowledge base. Engaging in these endeavors allows me to explore new technologies and techniques, fostering a deeper understanding of programming concepts. Whether it's crafting applications with Swift UI or constructing websites using Lightning Web Components (LWC), each project presents a unique challenge that drives me to sharpen my problem-solving abilities and creative thinking. Moreover, the autonomy afforded by side projects enables me to experiment freely, pushing the boundaries of what I can achieve and ultimately honing my craft as a software developer. Through this hands-on approach to learning, I not only enhance my proficiency in specific languages and frameworks but also cultivate a passion for innovation and discovery that fuels my growth as an advanced software engineer."
          )}
        </StyledText>
        {/* {!props.imagesOff && (
